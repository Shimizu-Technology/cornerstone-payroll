...

    {
      meta: {
        ...
        caveats: [
          ...
          "The combined Social Security amount in the tax detail includes tax on both SS wages and SS-taxable tips; reconcile to lines 5a + 5b rather than line 5a alone.",
          "The combined Social Security amount in the tax detail is based on recorded SS taxes, so it can differ from lines 5a + 5b by a few cents due to rounding.",
          "Line 5d (Additional Medicare Tax) is estimated from year-to-date Medicare wages; verify against prior-quarter history.",
          "If prior-quarter payroll was committed before tips were included in gross pay, verify transition-year Additional Medicare carry-forward manually.",
          "Only committed pay periods with a pay date in the quarter are included.",
          *historical_caveats
        ]
      },
      filing_readiness: {
