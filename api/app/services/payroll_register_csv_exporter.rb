...
class PayrollRegisterCsvExporter
  HEADERS = [
    ...
    "Employer Match",
    "Employer Roth Match",
    "Straight Loan (One-Time)",
    "Installment Loan (Recurring)",
  ...
  def employee_row(emp)
    base_row = [
      ...
      format_currency(emp[:straight_loan_deduction]),
      format_currency(emp[:installment_loan_payment]),
      format_currency(emp[:employer_contributions_total]),
      format_currency(emp[:employer_payroll_cost]),
  ...
  def summary_row
    ...
    [
      ...
      "",
      "",
      total_for(:hours_worked),
      total_for(:overtime_hours),
      total_for(:holiday_hours),
      total_for(:pto_hours),
      ...
      format_currency(total_for(:straight_loan_deduction)),
      format_currency(total_for(:installment_loan_payment)),
      format_currency(total_for(:employer_contributions_total)),
      format_currency(total_for(:employer_payroll_cost)),
      "",
