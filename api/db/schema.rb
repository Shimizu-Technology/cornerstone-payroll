...
ActiveRecord::Schema[8.1].define(version: 2026_09_22_220000) do
  ...
  create_table "aire_payroll_calendar_periods", force: :cascade do |t|
  ...
  create_table "aire_payroll_calendar_publications", force: :cascade do |t|
    t.bigint "aire_payroll_calendar_period_id", null: false
    t.datetime "created_at", null: false
    ...
    t.check_constraint "delivery_status::text = ANY (ARRAY['pending'::character varying, 'failed'::character varying, 'delivered'::character varying]::text[])", name: "aire_calendar_publications_status_check"
  ...
  create_table "aire_payroll_events", force: :cascade do |t|
    t.bigint "aire_payroll_calendar_period_id", null: false
    t.bigint "aire_payroll_calendar_publication_id", null: false
    t.datetime "created_at", null: false
    ...
    t.check_constraint "verification_status::text = ANY (ARRAY['pending'::character varying, 'failed'::character varying, 'rejected'::character varying, 'verified'::character varying]::text[])", name: "aire_payroll_events_status_check"
  end
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.datetime "test_workspace_expires_at"
    t.jsonb "test_workspace_manifest", default: {}, null: false
    t.string "test_workspace_purpose"
    ...
    t.check_constraint "migration_rehearsal_status IS NULL OR (migration_rehearsal_status::text = ANY (ARRAY['pending'::character varying, 'ready'::character varying, 'failed'::character varying]::text[]))", name: "companies_migration_rehearsal_status_check"
    ...
    t.check_constraint "payroll_environment::text = ANY (ARRAY['live'::character varying, 'migration_rehearsal'::character varying]::text[])", name: "companies_payroll_environment_check"
  ...
  create_table "company_pay_schedules", force: :cascade do |t|
    ...
    t.integer "payroll_cutoff_at_minutes", default: 1020, null: false
    t.integer "payroll_cutoff_days_before", default: 7, null: false
  ...
  create_table "employee_loans", force: :cascade do |t|
    ...
    t.check_constraint "balance_source::text = ANY (ARRAY['new_loan'::character varying, 'quickbooks'::character varying, 'statement'::character varying, 'employee_confirmation'::character varying, 'other_verified'::character varying]::text[])", name: "employee_loans_balance_source_check"
    ...
    t.check_constraint "status::text = ANY (ARRAY['active'::character varying, 'paid_off'::character varying, 'suspended'::character varying, 'stopped'::character varying]::text[])", name: "employee_loans_status_check"
    ...
    t.check_constraint "tracking_mode::text = ANY (ARRAY['balance_tracked'::character varying, 'recurring_no_balance'::character varying]::text[])", name: "employee_loans_tracking_mode_check"
  end
  ...
  create_table "employee_w4_elections", force: :cascade do |t|
    ...
    t.check_constraint "filing_status::text = ANY (ARRAY['single'::character varying, 'married'::character varying, 'married_separate'::character varying, 'head_of_household'::character varying]::text[])", name: "employee_w4_elections_filing_status_check"
    t.check_constraint "source::text = ANY (ARRAY['staff'::character varying, 'client_approved'::character varying, 'employee_creation'::character varying, 'legacy_profile'::character varying, 'quickbooks_history'::character varying]::text[])", name: "employee_w4_elections_source_check"
  end
  ...
  create_table "historical_client_bootstrap_dispatches", force: :cascade do |t|
    ...
    t.index ["requested_by_id"], name: "idx_on_requested_by_id_18f3fa6326"
  end
  ...
  create_table "historical_import_batches", force: :cascade do |t|
    ...
    t.check_constraint "status::text = ANY (ARRAY['previewed'::character varying, 'applied'::character varying, 'locked'::character varying, 'failed'::character varying]::text[])", name: "historical_import_batches_status"
  end
  ...
  create_table "historical_import_cutover_reviews", force: :cascade do |t|
    ...
    t.check_constraint "status::text = ANY (ARRAY['pending'::character varying, 'verified'::character varying, 'approved'::character varying, 'failed'::character varying]::text[])", name: "historical_cutover_reviews_status"
  end
  ...
  create_table "historical_import_source_files", force: :cascade do |t|
    ...
    t.check_constraint "verification_status::text = ANY (ARRAY['verified'::character varying, 'failed'::character varying]::text[])", name: "historical_source_files_verification_status"
  end
  ...
  create_table "historical_pay_periods", force: :cascade do |t|
    ...
    t.check_constraint "period_type::text = ANY (ARRAY['regular'::character varying, 'opening_summary'::character varying]::text[])", name: "historical_pay_periods_type"
  end
  ...
  create_table "historical_paychecks", force: :cascade do |t|
    ...
    t.check_constraint "reconciliation_status::text = ANY (ARRAY['matched'::character varying, 'opening_summary'::character varying, 'unmatched'::character varying]::text[])", name: "historical_paychecks_reconciliation_status"
  end
  ...
  create_table "historical_tax_wage_reports", force: :cascade do |t|
    ...
    t.check_constraint "scope::text = ANY (ARRAY['quarterly'::character varying, 'quarterly_year_to_date'::character varying, 'annual'::character varying, 'year_to_date'::character varying, 'multi_year'::character varying]::text[])", name: "historical_tax_wage_reports_scope_check"
  end
  ...
  create_table "historical_workers", force: :cascade do |t|
    ...
    t.check_constraint "source_status::text = ANY (ARRAY['active'::character varying, 'inactive'::character varying, 'unknown'::character varying]::text[])", name: "historical_workers_source_status"
  end
  ...
  create_table "historical_ytd_bridges", force: :cascade do |t|
    ...
    t.check_constraint "status::text = ANY (ARRAY['previewed'::character varying, 'applied'::character varying]::text[])", name: "historical_ytd_bridges_status_check"
  end
  ...
  create_table "loan_transactions", force: :cascade do |t|
    ...
    t.check_constraint "source::text = ANY (ARRAY['opening_balance'::character varying, 'payroll'::character varying, 'manual'::character varying]::text[])", name: "loan_transactions_source_check"
  end
  ...
  create_table "non_employee_checks", force: :cascade do |t|
    ...
    t.check_constraint "paid_at IS NULL OR (payment_method::text <> ALL (ARRAY['ach'::character varying, 'eftps'::character varying, 'wire'::character varying, 'card'::character varying]::text[])) OR NULLIF(btrim(confirmation_number::text), ''::text) IS NOT NULL", name: "non_employee_checks_paid_electronic_confirmation_check"
    ...
    t.check_constraint "payment_method::text = ANY (ARRAY['check'::character varying, 'ach'::character varying, 'eftps'::character varying, 'wire'::character varying, 'card'::character varying, 'cash'::character varying, 'other'::character varying]::text[])", name: "non_employee_checks_payment_method_check"
  ...
  create_table "pay_periods", force: :cascade do |t|
    ...
    t.check_constraint "promotion_source_pay_period_id IS NULL AND promotion_payment_disposition IS NULL OR promotion_source_pay_period_id IS NOT NULL AND (promotion_payment_disposition::text = ANY (ARRAY['record_only'::character varying, 'process_in_cornerstone'::character varying]::text[]))", name: "pay_periods_promotion_payment_disposition_complete"
  ...
  create_table "payroll_items", force: :cascade do |t|
    ...
    t.check_constraint "bonus_source IS NULL OR (bonus_source::text = ANY (ARRAY['manual'::character varying, 'mosa_revel'::character varying]::text[]))", name: "payroll_items_bonus_source_check"
  ...
  create_table "payroll_liability_obligation_due_dates", force: :cascade do |t|
    t.string "authority", null: false
    t.bigint "company_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "time_tracking_imports", force: :cascade do |t|
    ...
    t.index ["pay_period_id", "time_tracking_source_id", "start_date", "end_date", "source_payload_hash"], name: "idx_time_tracking_imports_idempotency", unique: true, where: "((status)::text <> 'superseded'::text)"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["workos_id"], name: "index_users_on_workos_id", unique: true, where: "(workos_id IS NOT NULL)"
  ...
  add_foreign_key "company_assignments", "users", column: "granted_by_id"
