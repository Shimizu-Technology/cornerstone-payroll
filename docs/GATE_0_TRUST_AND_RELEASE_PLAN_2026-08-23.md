...
| Legacy worker database credential | Unassigned | Former production worker database | `1d19362` | 2026-08-24 | [August 24 production evidence](PRODUCTION_READINESS_EVIDENCE_2026-08-24.md) | Credential is exposed and unresolved: rotate it immediately in every case; decide database retention or retirement only after rotation | Immediate rotation; retention decision follows separately |
