    ...
    <div>
      ...
      <section className="border-b border-neutral-200 bg-neutral-50/70 px-4 py-3 sm:px-6 lg:px-8" aria-label="Pay run identity">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {isTrainingBaseline && <span className="inline-flex items-center"><Badge variant="warning"><LockKeyhole className="mr-2 h-3.5 w-3.5" />Locked training baseline</Badge><HelpTip label="locked training baseline">This earlier payroll is view-only and preserves the year-to-date starting point for the practice exercises.</HelpTip></span>}
