            ...
            <div className="sticky top-0 z-20 border-b border-amber-300 bg-amber-50 px-4 py-2.5 text-amber-950 sm:px-6">
              <div className="mx-auto flex max-w-screen-2xl items-start gap-2.5 text-sm">
                ...
                <div>
                  ...
                  Changes stay in this rehearsal client. Payroll cannot be committed. Only VOID-marked rehearsal checks can be previewed and downloaded; real checks, payments, and filing-ready actions remain blocked.
